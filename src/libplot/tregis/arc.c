...
/*
 ...
 Abstract:	arc(x,y,x0,y0,x1,y1) draw a line from (x0,y0) to (x1,y1)
	with the center of the arc being (x,y)

 Modified by:

 Date:		By:		Reason:

 02-Apr-1985	Kevin Dunlap.	Add comments and debugging output.
