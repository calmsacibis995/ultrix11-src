...
/*
 ...
 Abstract:	open - open the LA100 printer for graphics output

    The open function is responsible for initlizing the variables
    for the LA100 Plot package and for sending the escape sequence
...
openpl()
{
	...
	printf("\33P0q");		/* turn on graphics mode on LA100 */
	for(tmpx=0; tmpx < MAXX; tmpx++) {
