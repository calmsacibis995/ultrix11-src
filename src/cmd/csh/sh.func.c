...
static char *Sccsid = "@(#)sh.func.c	3.0	4/21/86";
/*
 * Based on
 *	char *sccsid = "@(#)sh.func.c 4.5 81/06/19";
 */
...
dologin(v)
	char **v;
{
	chkstop = 0;	/* not until stopped jobs are resolved ! -jsd */
	islogin();
