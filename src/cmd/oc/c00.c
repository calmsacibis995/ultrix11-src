 ...
 *
 * Called from cc:
 *   c0 source temp1 temp2 [ profileflag ] [ overlayflag/non-overlayflag]
 * temp1 gets most of the intermediate code;
 * strings are put on temp2, which c1 reads after temp1.
 * The overlay/non-overlay flag is either -V or -V7, respectivly.  The
 * default is now -V.
 */

static char Sccsid[] = "@(#)c00.c 3.0 4/21/86";
#include "c0.h"
