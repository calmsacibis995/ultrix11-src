...
lefline = (int (*)[]) getcore(MAXHEAD*qcol, sizeof (int));
...
used = (int *) getcore(qcol, sizeof(int));
lused = (int *) getcore(qcol, sizeof(int));
rused = (int *) getcore(qcol, sizeof(int));
doubled = (int *) getcore(qcol, sizeof(int));
acase = (int *) getcore(qcol, sizeof(int));
topat = (int *) getcore(qcol, sizeof(int));
}
char *
getcore(a,b)
{
