...
#ifdef KEEPSCCSID
static char Sccsid[] = "@(#)pdp11.c	3.0	4/21/86";
#endif
#include "defs"
#if FAMILY == DMR
#	include "dmrdefs"
...
/*
 * This code yields stuff like "~~foo_ = _foo_", which
 * causes real problems for overlayed programs.  Since this is
 * only in the prdbginfo routine, it probably isn't used for
 * actual execution, just debugging.  6/28/84 -Dave Borman
 *
if(procclass != CLBLOCK)
