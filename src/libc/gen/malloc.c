 ...
 *	ALIGN, NALIGN, BLOCK, FRAG, BUSY, INT
 *	where INT is integer type to which a pointer can be cast
 *	and BLOCK and FRAG are multiples of WORD
*/
#define INT int
#define ALIGN int
#define NALIGN 1
...
#ifdef debug
/*	allock((char*)p-2) returns 1 if the arena is
 *	consistent and p points to a (busy or free)
 *	block in the arena, otherwise 0
 */
allock(q)
union store *q;
{
