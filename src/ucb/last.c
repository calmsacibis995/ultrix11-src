...
static	char *sccsid = "@(#)last.c	3.0	4/22/86";
/* Based on:
 *	"@(#)last.c	4.8 (Berkeley) 9/25/83";
 */
/*
...
#define	HMAX	12	/* 12 instead of 16 for prettier printout */
#define	SECDAY	(24L*60*60)
