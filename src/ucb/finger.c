...
static char Sccsid[] = "@(#)finger.c	3.0	4/22/86";
/*
 * Based on "finger.c	4.1 (Berkeley) 10/1/80";
 */
...
/*
 *  code to format phone numbers.  filled with
    ...
    struct  person	*pers;
{
	...
	if( !llopenerr )  {
	    lseek( lf, (long) pwdt->pw_uid*llsize, 0 );
