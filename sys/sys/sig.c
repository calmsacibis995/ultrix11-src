...
/*
 * SCCSID: @(#)sig.c	3.0	4/21/86
 * This is now back to only one file, because we always have
 * job control.  This version is from
 *	@(#)sigjcl.c	2.3	5/28/85
 * which is derived from
 *		SCCS id	@(#)sigjcl.c	1.16 (Berkeley)	11/6/82
 */
