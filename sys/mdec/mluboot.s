...
//////////////////////////////////////////////////////////////////////
/
/ ULTRIX-11 Block Zero Bootstrap for the ML11 Disk
/ Can only boot from unit zero.
/ Assumes disk at standard address (0176700),
/ because it could only be booted as HP from boot ROM.
/
/ Fred Canter
/
...
1:
	clr	r0		/ unit number
	mov	$8.,r1		/ boot device code
	mov	$hpcs1,r4	/ CSR address
	clr	r5
