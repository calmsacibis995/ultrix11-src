...
//////////////////////////////////////////////////////////////////////
/
/ ULTRIX-11 Block Zero Bootstrap for RM02/3/5 and RP04/5/6 Disks
/ Boot from any unit
/ Assumes disk at standard address (0176700).
/
/ Fred Canter
/
...
/ set disk geometry per drive type
	...
	mov	*$hpcs2,bdunit	/ save boot from unit number
	bic	$!7,bdunit	/ only on initial entry
	cmpb	*$hpdt,$24	/ Check drive type, set nsec & ntrk
	blt	9f		/ rp04/5/6
	mov	$32.,nsec	/ rm02/3
	cmpb	*$hpdt,$27
	bne	8f
...
/ assembler header
1:
	mov	bdunit,r0	/ boot device unit number
	mov	$3,r1		/ boot device code
	mov	$hpcs1,r4	/ boot device CSR address
	clr	r5
...
.endif
	div	nbpc,r0
/	add	$cyl,r0	/ don't need, make room for rm05
	mov	r0,*$hpca
	clr	r0
	div	nsec,r0
	swab	r0
